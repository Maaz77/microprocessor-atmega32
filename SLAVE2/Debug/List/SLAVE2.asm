...
; 0000 0070 DDRA=(1<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
;	a -> R16,R17
;	b -> R18,R19
;	address -> R21
	__GETWRN 16,17,0
...
; 0000 008B TCCR0=(1<<WGM00) | (1<<COM01) | (0<<COM00) | (1<<WGM01) | (0<<CS02) | (0<<CS01) | (0<<CS00);
	LDI  R30,LOW(104)
	OUT  0x33,R30
...
; 0000 00BD // USART Transmitter: Off
; 0000 00BE // USART Mode: Sync. Slave UCPOL=1
...
; 0000 00C0 UCSRB=(1<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (1<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	LDI  R30,LOW(144)
	OUT  0xA,R30
; 0000 00C1 UCSRC=(1<<URSEL) | (1<<UMSEL) | (0<<UPM1) | (0<<UPM0) | (0<<USBS) | (1<<UCSZ1) | (1<<UCSZ0) | (1<<UCPOL);
	LDI  R30,LOW(199)
	OUT  0x20,R30
...
; 0000 00E1 // Characters/line: 8
; 0000 00E2 lcd_init(8);
	LDI  R26,LOW(8)
	RCALL _lcd_init
; 0000 00E3 
...
; 0000 00EA       address = getchar();
	RCALL _getchar
	MOV  R21,R30
; 0000 00EB 
; 0000 00EC 
; 0000 00ED       if(address == 0x02){
	CPI  R21,2
	BRNE _0xD
; 0000 00EE           a = getchar();
	RCALL _getchar
